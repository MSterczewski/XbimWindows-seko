...
namespace Xbim.Presentation
{
	public partial class IfcActionPanel : INotifyPropertyChanged
	{
		...
		public IfcActionPanel()
		{
			...
			_tcpPort = int.Parse(ConfigurationManager.AppSettings["TCPListeningPort"]);
			_showDiagMsg = bool.Parse(ConfigurationManager.AppSettings["ShowDiagnosticMsg"]);
			_communicationDataSeparator = ConfigurationManager.AppSettings["CommunicationDataSeparator"];
			_communicationDataGroupSeparator = ConfigurationManager.AppSettings["CommunicationDataGroupSeparator"];
